...
contract BuyLand is Land,events,Bid{
    ...
    function buy(IERC721 _nft,uint256 _id,int256 _dimensionX,int256 _dimensionY,int256 _dimensionZ,int256 _positionX,int256 _positionY,int256 _positionZ,uint256 _basePrice,string memory _URI) public payable{
        ...
        if(plots[_id].plotOwner==payable(address(0))){
            ...
            // plots[_id].nft.safeTransferFrom(plots[_id].plotOwner,msg.sender,_id);
